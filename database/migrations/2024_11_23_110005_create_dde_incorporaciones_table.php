...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('dde_incorporaciones', function (Blueprint $table) {
            ...
            $table->integer('cumple_exp_profesional_incorporacion')->nullable();
            $table->integer('cumple_exp_especifica_incorporacion')->nullable();
            $table->integer('cumple_exp_mando_incorporacion')->nullable();
            $table->integer('cumple_formacion_incorporacion')->nullable();
