...
class IncorporacionesController extends Controller
{
    ...
    public function generarFormR0078($incorporacionId)
    {
        ...
        $pathTemplate = $disk->path('R-0078.docx');
    ...
    public function generarFormR1401($incorporacionId)
    {
        ...
        $disk = Storage::disk('form_templates');
        $pathTemplate = $disk->path('R-1401.docx');
        $templateProcessor = new TemplateProcessor($pathTemplate);
    ...
    public function generarFormR1023($incorporacionId)
    {
        ...
        $pathTemplate = $disk->path('R-1023.docx');
    ...
    public function generarFormR1129($incorporacionId)
    {
        ...
        $pathTemplate = $disk->path('R-1129.docx'); // ruta de plantilla
    ...
    public function generarFormR0980($incorporacionId)
    {
        ...
        $pathTemplate = $disk->path('R-0980.docx');
    ...
    public function generarFormR1418($incorporacionId)
    {
        ...
        $disk = Storage::disk('form_templates');
        $pathTemplate = $disk->path('R-1418.xlsx');
    ...
    public function generarFormR1419($incorporacionId)
    {
        ...
        $disk = Storage::disk('form_templates');
        $pathTemplate = $disk->path('R-1419.xlsx');
        $spreadsheet = IOFactory::load($pathTemplate);
        $sheet = $spreadsheet->getActiveSheet();
    ...
    public function generarR1469($incorporacionId)
    {
        $incorporacion = Incorporacion::find($incorporacionId);
        ...
        $disk = Storage::disk('form_templates');
        $pathTemplate = $disk->path('R-1469.docx');
        $templateProcessor = new TemplateProcessor($pathTemplate);
        ...
        $nombreCompleto = mb_strtoupper(
            $incorporacion->persona->nombre_persona . ' ' .
                $incorporacion->persona->primer_apellido_persona . ' ' .
                $incorporacion->persona->segundo_apellido_persona,
            "UTF-8"
        );
        $templateProcessor->setValue('persona.nombreCompleto', $nombreCompleto);

        $fileName = 'R-1469-01 ' . $incorporacion->persona->nombre_persona . ' ' . $incorporacion->persona->primer_apellido_persona . ' ' . $incorporacion->persona->segundo_apellido_persona . ' ' . $incorporacion->descargas;
